...
from xs2n.utils.auth.codex_auth import (
    DEFAULT_CODEX_BASE_URL,
    build_codex_login_command,
    build_codex_logout_command,
    build_codex_status_command,
)
from xs2n.utils.auth.credentials import resolve_model_credentials
...
def test_resolve_model_credentials_prefers_codex_auth_over_openai_api_key(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
    codex_home = tmp_path / ".codex"
